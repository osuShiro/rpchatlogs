...
def sessions(request, game_name, session_name=None):
    ...
    if request.method == 'POST':
        return sessions_post(request, game)
...
@login_required()
def sessions_post(request, game):
    keys = request.POST.keys()
